...
/**
 * Clase Mailer
 * Maneja el envío de correos electrónicos usando PHPMailer o mail() de PHP
 */
...
class Mailer {
    ...
    // Enviar correo simple usando mail() de PHP
    public function sendSimpleMail($to, $subject, $message) {
    ...
    public function sendVerificationCode($to, $code, $nombre = '') {
        $subject = "Código de Recuperación - Hersil Shop";
        ...
        return $this->sendSimpleMail($to, $subject, $message);
    }

    // Enviar correo de bienvenida
    public function sendWelcomeEmail($to, $nombre) {
        $subject = "¡Bienvenido a Hersil Shop! 🎉";
            ...
            <div class='container'>
                ...
                <div class='content'>
                    ...
                    <div style='text-align: center;'>
                        <a href='" . ($_ENV['APP_URL'] ?? 'http://localhost/hersil_php') . "/productos' class='button'>
                            Ver Productos
                        </a>
                    </div>
